...
import com.sjgroup.android_imperative.activities.HistoryActivity
...
class HistoryAdapter(var activity: HistoryActivity, var items: ArrayList<TVShow>) : BaseAdapter() {
